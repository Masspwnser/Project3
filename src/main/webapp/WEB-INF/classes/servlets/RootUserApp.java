...
public class RootUserApp extends HttpServlet {
	...
	public RootUserApp() throws SQLException, IOException {
		...
		FileInputStream filein = new FileInputStream(
				"D:/eclipse/java-2021-03/eclipse-workspace/Project3/src/main/webapp/WEB-INF/lib/root.properties");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// If query contains shipments, do business logic
			if (query.toLowerCase().contains("shipments")) {
				...
				if (temp.startsWith("update") || temp.startsWith("insert")) {
					...
					// Old logic
					/* int changes  = statement.executeUpdate("UPDATE suppliers SET status = status + 5 "
